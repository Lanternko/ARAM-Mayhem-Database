...
// GitHub Pages deep-link bootstrap: lightweight path shells (and 404.html)
    ...
    const DATA = await loadSitePayload("api/tier-list.json?v=20260809-1786261090");
    ...
    const DATE_STR_ZH = "更新於 2026-08-10";
    const BUILD_DATE = "2026-08-10";
    const PATCH_LABEL = "patch 26.15";
    const TOTAL_GAMES = "498,150";
