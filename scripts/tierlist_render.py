...
def render_html(
    ...
    *,
    ...
    parts.append(
        ...
        "<p class='draft-help' data-i18n-zh='先選我方英雄；切換右側對手後再選敵方。已選英雄會在兩側 roster 與中央池同步標記。' "
        "data-i18n-en='Pick allies first, then switch to Opponent for the enemy roster. Selected champions stay marked in both rosters and the pool.'>"
        "先選我方英雄；切換右側對手後再選敵方。已選英雄會在兩側 roster 與中央池同步標記。</p>"
        "</section>"
