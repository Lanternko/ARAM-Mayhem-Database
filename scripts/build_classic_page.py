...
.hero-tile.champ::before{content:"";position:absolute;inset:0;border-radius:inherit;padding:2px;
background:var(--tier-bg,var(--tier-color,#555));pointer-events:none;z-index:4;
