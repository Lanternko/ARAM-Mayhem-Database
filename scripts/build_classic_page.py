...
.classic-tabs{display:flex;gap:2px;margin:0 0 18px;border-bottom:1px solid var(--border);overflow-x:auto;overflow-y:hidden;scrollbar-width:none}.classic-tabs::-webkit-scrollbar{display:none}.classic-tab{position:relative;min-height:44px;padding:0 16px;border:0;background:transparent;color:var(--text-muted);font:600 14px inherit;white-space:nowrap;cursor:pointer}.classic-tab[aria-selected="true"]{color:var(--text)}.classic-tab[aria-selected="true"]::after{content:"";position:absolute;right:16px;bottom:-1px;left:16px;height:2px;background:var(--focus)}
...
.hero-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:10px 8px}.hero-tile{display:grid;gap:5px;min-width:0;border:0;background:transparent;padding:0;cursor:pointer;color:var(--text);text-align:left}.tile-icon{position:relative;aspect-ratio:1;border:1px solid var(--border);border-radius:8px;background:var(--chip-bg);overflow:hidden}.hero-tile img{width:100%;height:100%;object-fit:cover;display:block}.tile-icon::after{content:"";position:absolute;inset:0;background:rgba(10,11,13,.12);pointer-events:none}.tile-name,.tile-stat{font-variant-numeric:tabular-nums;pointer-events:none}.tile-name{padding:0 2px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:600;line-height:1.25}.tile-stat{position:absolute;z-index:1;left:4px;bottom:4px;padding:2px 4px;border-radius:4px;background:rgba(10,11,13,.9);font-size:10px;font-weight:700;line-height:1.2}.hero-tile[aria-pressed="true"] .tile-icon{border:2px solid var(--focus);box-shadow:0 0 0 2px rgba(245,197,24,.16)}
...
@media (max-width:699px){.site-header-meta{display:none}.research-context{margin-top:0}.research-context strong{width:100%}.classic-tabs{margin-right:-10px;margin-left:-10px;padding:0 10px}.research-bar{align-items:flex-start;flex-wrap:wrap;gap:8px;margin-bottom:14px}.filter-chips{width:100%;max-width:100%;flex-wrap:wrap;gap:4px}.filter-chip{min-height:34px;padding:4px 10px;font-size:11px}.filter-count{display:none}.filter-search{width:100%;min-width:0;margin-left:0}.data-section-head{align-items:flex-start;flex-direction:column}.data-section-head p{text-align:left}.table-scroller{margin-right:-2px;margin-left:-2px}.hero-detail{padding:12px}.detail-head h2{font-size:18px}.detail-items-head{align-items:flex-start;flex-direction:column}.item-note{align-items:flex-start}}
"""
