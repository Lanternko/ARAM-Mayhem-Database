    ...
    const COPY = {
        zh: {
            ...
            updatesItems: [
                ...
                '2026-05-22：隊友推薦加入隊伍組成修正，納入前排、AD/AP、poke、清線與開戰缺口。',
                '2026-05-22：增幅裝置排序納入選取率訊號，低選取率高勝率會更保守看待。',
            ],
            recModeOn: '選擇你的隊友：開',
            recModeOff: '選擇你的隊友：關',
        ...
        en: {
            ...
            updatesItems: [
                ...
                '2026-05-22: Teammate recommendations now include composition corrections for frontline, AD/AP mix, poke, waveclear, and engage gaps.',
                '2026-05-22: Augment rankings now use a pick-rate signal, so low-pick high-win results are treated more conservatively.',
            ],
